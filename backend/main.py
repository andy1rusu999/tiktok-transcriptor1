...
cors_origins = os.environ.get("CORS_ORIGINS", "http://localhost:5173,http://127.0.0.1:5173,http://165.227.169.91,http://165.227.169.91:80,https://transcribe.propagandahunter.net")
